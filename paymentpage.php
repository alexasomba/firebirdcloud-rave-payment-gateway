		...
		<script>
			document.addEventListener("DOMContentLoaded", function(event) {
				addEventListener("load", function(e) {
					var PBFKey = "<?php $envPBFKey = getenv('RAVE-PUBLIC-KEY');
									echo $envPBFKey; ?>"; // replace with your rave public key, Get your public key from your rave account's dashboard
					getpaidSetup({
						PBFPubKey: PBFKey,
						amount: <?php $sellingCurrencyAmount = $_GET['sellingcurrencyamount'];echo $sellingCurrencyAmount; ?>,
						country : "<?php $envCountry = getenv('COUNTRY');
									echo $envCountry; ?>", // replace with your country
						currency: "<?php $envCurrency = getenv('CURRENCY');
									echo $envCurrency; ?>", // replace with your currency
						custom_logo: "<?php $envCustomLogo = getenv('CUSTOM-LOGO-URL');
										echo $envCustomLogo; ?>", // replace with link to your custom logo
						custom_title: "<?php $envCustomTitle = getenv('CUSTOM-MODAL-TITLE');
										echo $envCustomTitle; ?>", // replace with link to your custom tittle
						custom_description: "<?php $envCustomDescription = getenv('CUSTOM-MODAL-DESCRIPTION');
												echo $envCustomDescription; ?>", // replace with your custom description
						customer_email: "<?php $emailAddr = $_GET['emailAddr'];
											echo $emailAddr; ?>",
						customer_firstname: "<?php $name = $_GET['name'];
												echo $name; ?>",
						customer_phone: "<?php $telNo = $_GET['telNo'];
											echo $telNo; ?>",
						txref: "<?php $transId = $_GET['transid'];
								echo $transId; ?>",
